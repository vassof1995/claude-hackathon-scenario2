# ADR-0007: Reporting DB on RDS PostgreSQL with Read Replica

- **Status:** Accepted
- **Date:** 2026-06-30
- **Deciders:** Team The 4am Club

> See **ADR-0002** (`decisions/0002-target-cloud-aws.md`, target cloud — already names "RDS Postgres + read replica" for reporting) and **ADR-0003** (`decisions/0003-secrets-hook-vs-prompt.md`, secrets — AWS Secrets Manager / SSM references, no plaintext). Implements the reporting-db workload in the migration plan (`docs/03-migration-plan.md` §4).
